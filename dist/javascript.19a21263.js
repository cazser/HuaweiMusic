...
},{}],"src/javascript/jquery-3.6.0.js":[function(require,module,exports) {
...
},{"process":"node_modules/process/browser.js"}],"src/javascript/swiper.js":[function(require,module,exports) {
"use strict";
...
var _jquery = _interopRequireDefault(require("./jquery-3.6.0.js"));
...
var Player = /*#__PURE__*/function () {
  function Player(node) {
    ...
    this.root = typeof node === 'string' ? (0, _jquery.default)(node) : node;
    this.songList = [];
    this.currentIndex = 0;
    this.start();
  ...
  _createClass(Player, [{
    ...
    value: function bind() {
      ...
      var $playPauseToggle = (0, _jquery.default)('.btn-play-pause');
      (0, _jquery.default)(".btn-play-pause", this.root).click(function () {
        console.log("点击了");

        if ($playPauseToggle.hasClass("pause")) {
          $playPauseToggle.removeClass("pause").addClass("playing");
          (0, _jquery.default)("use", $playPauseToggle).attr("xlink:href", "#icon-pause");

          _this2.playSong();
        } else if ($playPauseToggle.hasClass("playing")) {
          $playPauseToggle.removeClass("playing").addClass("pause");
          (0, _jquery.default)("use", $playPauseToggle).attr("xlink:href", "#icon-play");

          _this2.audio.pause();
        }
      });
      var $btnPre = (0, _jquery.default)(".btn-pre", this.root);
      $btnPre.click(function () {
        _this2.playPrevSong();
      });
      (0, _jquery.default)('.btn-next', this.root).click(function () {
        return _this2.playNextSong();
      }); //   $(".panels").click(()=> console.log("panel "))

      (0, _jquery.default)('.panels').on('swipeleft', function () {
        console.log("左滑");
        (0, _jquery.default)('.panels').removeClass('panel1').addClass('panel2');
      });
      (0, _jquery.default)('.panels').on('swiperight', function () {
        console.log("右滑");
        (0, _jquery.default)('.panels').removeClass('panel2').addClass('panel1');
      });
...
var app = new Player('#player');
app.playSong();
},{"./icons.js":"src/javascript/icons.js","./jquery-3.6.0.js":"src/javascript/jquery-3.6.0.js","./swiper.js":"src/javascript/swiper.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
